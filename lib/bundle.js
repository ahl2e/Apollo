...
const PracticeView = __webpack_require__(/*! ./practice_view */ "./lib/practice_view.js");
const Practice = __webpack_require__(/*! ./practice.js */ "./lib/practice.js");
...
class Game{
  ...
  directionsDraw(ctx){
    ...
    ctx.fillText('Press space to quit', 940,60);
  }
  ...
  preview(ctx){
    ...
    ctx.fillText('Welcome to Apollo', 200,140);
    ctx.font = "30px Share Tech Mono";
    ctx.fillText('Based on the arcade classic Lunar Lander', 200,180);
    ctx.fillStyle = "white";
    ...
    ctx.fillStyle = "green";
    ctx.font = "50px Share Tech Mono";
    ctx.fillText(`Click to Start Game`,200,500);
    ctx.font = "25px Share Tech Mono";
    ctx.fillText(`Press Enter for Practice Mode`,200,550);
    ctx.closePath();
  }
...
class Lander {
  ...
  checkLanding(ctx){
    ...
    if(this.pos[1] > 580){
      if(this.angle == 1 && this.velo[1] < 0.25 && this.velo[0] < 0.25 && this.crashed == false){
        this.landed = true;
        this.velo = [0,0];
        this.gameOver = true;
        this.landings ++;
...
class Practice{
  ...
  directionsDraw(ctx){
    ctx.fillStyle = "green";
    ctx.font = "30px Share Tech Mono";
    ctx.fillText('Welcome to Practice Mode', 800,60);
    ctx.font = "20px Share Tech Mono";
    ctx.fillText('Press space to quit', 800,80);
  }
...
Practice.X_DIMENSION = 1300;
Practice.Y_DIMENSION = 800;
Practice.FPS = 60;
...
class PracticeView{
  constructor(practice, ctx){
    this.ctx = ctx;
    this.practice = new Practice();
    this.lander = this.practice.lander;
    this.rocketSound = new Sound('rocket-sound.mp3');
    this.theme = document.getElementById('theme');
    }
  ...
  splash(){
    let theme = document.getElementById('theme');
    // document.getElementById("music-toggle").addEventListener("click",theme.play())
    this.practice.preview(this.ctx);
    this.handleInput();
    window.frames = requestAnimationFrame(this.splash.bind(this));
  }
  ...
  start(ctx){
    ...
    this.ctx.closePath();
    this.animate();
    this.practice.surfaceDraw(this.ctx);
  }

  showLanding(){
    this.practice.draw(this.ctx);
    this.practice.surfaceDraw(this.ctx);
    if (this.lander.gameOver == true && this.lander.fuel < 1){
      this.ctx.fillStyle = "green";
      this.ctx.font = "50px Share Tech Mono";
