...
class Game{
  ...
  points(){
    ...
    for (var i = 0; i < 64; i++) {
      ...
      var yCoord = Math.floor(Math.random() * (maxElevation-minElevation) + minElevation);
...
//   getRandomY(){
//     yCoord = 200;
//     return Math.floor(Math.random(yCoord * 2));
//   }
// }
...
class Lander {
  ...
  checkLanding(ctx){
    if(ctx.isPointInPath(this.pos[0] + 20,this.pos[1]+20) || ctx.isPointInPath(this.pos[0],this.pos[1]+20)){
